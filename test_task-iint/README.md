...
The application under test was a blog platform. A website where users can sign up, log in, and write and read blog posts. Built using Ruby on Rails, and packaged with Docker so it could be set up and run consistently on any computer.
