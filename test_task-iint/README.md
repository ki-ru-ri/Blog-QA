# Blog Platform — QA Test Assignment

This repo contains the original provided application plus the QA work done
against it: a feature/test plan, a set of bug tickets, and automated
regression specs for the most significant defects found.
